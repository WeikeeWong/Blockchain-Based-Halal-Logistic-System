...
import { Button, Table, Menu, Dropdown, Form, Select, Grid , Cell, Item} from 'semantic-ui-react';
...
class showCont extends Component{
    ...
    renderShow(){
        ...
        for (var i = 0; i < data.length; i++){
            if (data[i][0].Booked == 'Non-Available'){
                temp.push(data[i])
            };
        }  
    ...
    render(){
        ...
        <Layout>
            ...
            <span> </span>
            <h3 align="center" style={{color:'#ffffff', fontWeight:'bold'}} >Not Available Container Details</h3>
